                ...
                device
                    .build_input_stream(
                        ...
                        move |data: &[i16], _: &cpal::InputCallbackInfo| {
                            process_chunk(data, channels, &mut producer, &dropped_samples, |s| {
                                s as f32 / 32_768.0
                            });
                        },
                        err_fn,
                ...
                device
                    .build_input_stream(
                        ...
                        move |data: &[f32], _: &cpal::InputCallbackInfo| {
                            process_chunk(data, channels, &mut producer, &dropped_samples, |s| s);
                        },
                        err_fn,
                        None,
                    )
...
pub fn process_chunk<T: Copy>(
    ...
    for frame_start in (0..frames * channels).step_by(channels) {
